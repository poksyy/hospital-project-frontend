...
interface RemoteNurseApi {
    ...
    // TEST
    @GET("nurse/directory") suspend fun getRemoteNurse(): Response<List<Nurse>>

    // POST /authentication -> login()
    @POST("nurse/authentication") suspend fun login(@Body nurse: Nurse): Response<Nurse>

    // POST /registration -> register()
    @POST("nurse/registration") suspend fun postRegistration(@Body nurse: Nurse): Response<Nurse>

    // GET /directory -> getNurseDirectory()
    @GET("nurse/directory") suspend fun getNurseDirectory(): Response<List<Nurse>>
    ...
    @GET("nurse/profile/{id}") suspend fun getProfile(@Path("id") id: Int): Response<Nurse>
    ...
    @DELETE("nurse/deletion/{id}") suspend fun deleteNurse(@Path("id") id: Int): Response<String>
